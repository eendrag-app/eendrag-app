...
| Block | Owner |
| --- | --- |
| 0100–0199 | core — 0100 init, 0101 privilege-guard fix, 0102 guard order on fresh databases, 0103 grants, 0104 drop section colours, 0105 push subscriptions + notification delivery columns, 0106 backfill push state, 0107 verified-emails allowlist + name prefill, 0108 rename District to District 12 |
...
| 0500–0599 | intersection — 0500 init, 0501 drops players and rosters, 0502 group tie-break chosen by the HK, 0503 seasons + carried-over points, 0504 points scheme matched to the old app |
| 0600–0699 | profile |
